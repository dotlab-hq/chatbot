    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-[280px] border-r border-border/30 bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden sm:w-[320px]"
        ...
        >
          ...
          <div className="flex h-full w-full flex-col overflow-y-auto pt-0">{children}</div>
        </SheetContent>
      </Sheet>
    )
  }
